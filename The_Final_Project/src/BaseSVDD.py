...
class BaseSVDD(BaseEstimator, OutlierMixin):
    ...
    def fit(self, X, y=None, weight=None):
        ...
        self.display = 'off'
        self.predicted_y_, self.roc_auc = self.predict(self.X, self.y)
    ...
    def predict(self, X, y=None):
        ...
        if results['exist_y'] == True:
            ...
            results['roc-auc'] = roc_auc_score(results['y'], results['distance'])
        ...
        return results['predicted_y'], results['roc-auc']
    ...
    def display_predict(self, results):
        ...
        if results['exist_y'] == True:
            ...
            print('auc                  = %.4f %%'        % (100*results['roc-auc']))
        print('\n')  
